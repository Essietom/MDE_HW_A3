 ...
 * </p>
 * <ul>
 *   <li>{@link cryptoExchangeVersion1.impl.TokenImpl#getName <em>Name</em>}</li>
 *   <li>{@link cryptoExchangeVersion1.impl.TokenImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link cryptoExchangeVersion1.impl.TokenImpl#getDecimal <em>Decimal</em>}</li>
 *   <li>{@link cryptoExchangeVersion1.impl.TokenImpl#getTokenNetwork <em>Token Network</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TokenImpl extends MinimalEObjectImpl.Container implements Token {
	...
	protected EClass eStaticClass() {
		return CryptoExchangeVersion1Package.Literals.TOKEN;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CryptoExchangeVersion1Package.TOKEN__NAME, oldName, name));
	}
	...
	public void setAddress(String newAddress) {
		...
		address = newAddress;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CryptoExchangeVersion1Package.TOKEN__ADDRESS, oldAddress, address));
	}
	...
	public void setDecimal(int newDecimal) {
		...
		decimal = newDecimal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CryptoExchangeVersion1Package.TOKEN__DECIMAL, oldDecimal, decimal));
	}
	...
	public TokenNetwork getTokenNetwork() {
		if (tokenNetwork != null && tokenNetwork.eIsProxy()) {
			...
			if (tokenNetwork != oldTokenNetwork) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CryptoExchangeVersion1Package.TOKEN__TOKEN_NETWORK, oldTokenNetwork, tokenNetwork));
			}
		}
		return tokenNetwork;
	}
	...
	public void setTokenNetwork(TokenNetwork newTokenNetwork) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CryptoExchangeVersion1Package.TOKEN__TOKEN_NETWORK, oldTokenNetwork, tokenNetwork));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CryptoExchangeVersion1Package.TOKEN__NAME:
				return getName();
			case CryptoExchangeVersion1Package.TOKEN__ADDRESS:
				return getAddress();
			case CryptoExchangeVersion1Package.TOKEN__DECIMAL:
				return getDecimal();
			case CryptoExchangeVersion1Package.TOKEN__TOKEN_NETWORK:
